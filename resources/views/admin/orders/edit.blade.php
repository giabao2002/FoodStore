<x-layouts.admin title="Cập nhật đơn hàng #{{ $order->order_number }}">
    <div class="p-6">
        <div class="mb-6">
            <a href="{{ route('admin.orders.show', $order) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800">
            ...
            <div class="p-6">
                <form action="{{ route('admin.orders.update', $order) }}" method="POST">
                                    ...
                                    @foreach($order->orderItems as $index => $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" name="items[{{ $index }}][price]" value="{{ $item->price }}" class="w-24 focus:ring-blue-500 focus:border-blue-500 shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" name="items[{{ $index }}][quantity]" value="{{ $item->quantity }}" min="1" class="w-20 focus:ring-blue-500 focus:border-blue-500 shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-6 flex justify-end space-x-3">
                        <a href="{{ route('admin.orders.show', $order) }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Hủy
                        </a>
